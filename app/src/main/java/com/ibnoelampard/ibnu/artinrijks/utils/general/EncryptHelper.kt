...
object HASH {
    ...
    fun md5(text: String): String {
        return String(encodeHex(md5Bytes(EncryptHelper.getRawBytes(text))))
    }
    ...
    fun sha1(text: String): String {
        return String(encodeHex(sha1Bytes(EncryptHelper.getRawBytes(text))))
    }
    ...
    fun sha256(text: String): String {
        return String(encodeHex(sha256Bytes(EncryptHelper.getRawBytes(text))))
    }
